...
const AddAttendance = () => {
    ...
    useEffect(() => {
        const checkAttendanceStatus = async () => {
            try {
                const response = await axios.get(`https://employeems-server-eta.vercel.app/api/attendance/status/${id}`, {
                    headers: {
    ...
    const handleCheckIn = async () => {
        try {
            const response = await axios.post("https://employeems-server-eta.vercel.app/api/attendance/checkin", {}, {
                headers: {
                    "Authorization": `Bearer ${getToken()}`,
                },
            });
    ...
    const handleCheckOut = async () => {
        try {
            const response = await axios.post("https://employeems-server-eta.vercel.app/api/attendance/checkout", {}, {
                headers: {
                    "Authorization": `Bearer ${getToken()}`,
                },
            });
